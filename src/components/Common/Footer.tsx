      ...
      {!simple && (
        <div className="w-full py-10 px-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="flex-1 lg:flex-2">
            <p className="text-secondary font-title font-semibold mb-1">Vamos conversar?</p>
            <h2 className="text-4xl lg:text-6xl font-title font-bold text-primary">Entre em contato</h2>
          </div>
